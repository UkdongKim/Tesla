...
//세부제원 MODELS S(1) vs Plain(2)
    ...
    function size_check(){
        console.log('sizecheck 동작' + window.innerWidth)
...
$(function () {
    ...
    // left-nav-bar 및 to top 클릭시 해당 섹션으로 이동. 코드 줄이기 전
    // $(".toTop").click(function () {
    //     $("html, body").stop().animate({scrollTop: 0}, "slow");
    //     return false;
    // });
    // //    index_box 클릭시 해당 페이지로 이동
    // $(".index_box li:nth-of-type(1)").click(function () {
    //     $("html, body").stop().animate({scrollTop: $('.section1').offset().top}, "slow");
    //     return false;
    // });
    //
    // $(".index_box li:nth-of-type(2)").click(function () {
    //     $("html, body").stop().animate({scrollTop: $('.section2').offset().top}, "slow");
    //     return false;
    // });
    //
    // $(".index_box li:nth-of-type(3)").click(function () {
    //     $("html, body").stop().animate({scrollTop: $('.section3').offset().top}, "slow");
    //     return false;
    // });
    //
    // $(".index_box li:nth-of-type(4)").click(function () {
    //     $("html, body").stop().animate({scrollTop: $('.section5').offset().top}, "slow");
    //     return false;
    // });
    //
    // $(".index_box li:nth-of-type(5)").click(function () {
    //     $("html, body").stop().animate({scrollTop: $('.section6').offset().top}, "slow");
    //
    //     return false;
    //
    // })
